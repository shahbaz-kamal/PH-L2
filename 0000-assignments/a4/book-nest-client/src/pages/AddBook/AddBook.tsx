...
const AddBook = () => {
  ...
  return (
    <div className="w-11/12 md:w-10/12 mx-auto">
      ...
      <title>Add Books || BookNest</title>
      <main>
        <form
        ...
        >
          ...
          <div className="flex flex-col  md:col-span-2 gap-2">
            ...
            <Button
              ...
              {...register("available")}
              name="available"
              className="hover:cursor-pointer w-full rounded-md bg-light-primary dark:bg-dark-primary hover:bg-light-primary/80 dark:hover:bg-dark-primary/90 px-4 py-3 text- dark:text-light-text text-lg font-semibold  outline-none transition-all"
            >
              Submit
            </Button>
          </div>
