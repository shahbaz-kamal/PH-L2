...
export const bookSlice = createSlice({
  ...
  reducers: {
    ...
    setDetailsPageData: (state, action) => {
      const { detailsPageData } = action.payload;
      state.detailsPageData = detailsPageData;
    },
    setEditPageData: (state, action) => {
      const { editPageData } = action.payload;
      state.editPageData = editPageData;
    },
  },
});
